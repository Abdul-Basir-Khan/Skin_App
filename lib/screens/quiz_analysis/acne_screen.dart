...
import 'package:skin/screens/quiz_analysis/childbirth_screen.dart';
import 'package:skin/theme/app_colors.dart';


class AcneScreen extends StatefulWidget {
  const AcneScreen({super.key});

  @override
  State<AcneScreen> createState() => _AcneScreenState();
}

class _AcneScreenState extends State<AcneScreen> {
  ...
  Widget build(BuildContext context) {
    return  ReusableForScreen(requiresWidget: Column(
      ...
      children: [
        const ReusableText(title: 'Were any of your dark spots caused by acne?',weight: FontWeight.w600,size: 18,color: AppColors.buttonColor,),
        ...
        GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>const ChildbirthScreen()));
            },
