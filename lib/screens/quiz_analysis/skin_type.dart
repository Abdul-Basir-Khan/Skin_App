...
import 'package:skin/screens/quiz_analysis/identify_screen_type.dart';
...
class _SkinTypeScreenState extends State<SkinTypeScreen> {
  ...
  Widget build(BuildContext context) {
    return  ReusableForScreen(requiresWidget: Column(
      ...
      children: [
        const ReusableText(title: 'What is your skin type?',weight: FontWeight.w600,size: 18,color: AppColors.buttonColor,),
        ...
        GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>const IdentifySkinTypeScreen()));
            },
